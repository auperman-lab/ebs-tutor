...
const learnData = [
	...
	{
		title: 'You will learn how to take your designs and build them into powerful websites using Webflow, a state of the art site builder used by teams at Dell, NASA and more.',
	},
	{
		title: 'Learn to use Python professionally, learning both Python 2 and Python 3!',
	},
	{
		title: 'Get an understanding of how to create GUIs in the Jupyter Notebook system!',
	},
];

const forData = [
	{
		title: 'This course is for those who want to launch a Freelance Web Design career.',
	},
	{
		title: 'Praesent eget consequat elit. Duis a pretium purus.',
	},
	{
		title: 'Sed sagittis suscipit condimentum pellentesque vulputate feugiat libero nec accumsan.',
	},
	{
		title: 'Sed nec dapibus orci integer nisl turpis, eleifend sit amet aliquam vel, lacinia quis ex.',
	},
	{
		title: 'Those who are looking to reboot their work life and try a new profession that is fun, rewarding and highly in-demand.',
	},
	{
		title: 'Nunc auctor consequat lorem, in posuere enim hendrerit sed.',
	},
	{
		title: 'Duis ornare enim ullamcorper congue consectetur suspendisse interdum tristique est sed molestie.',
	},
