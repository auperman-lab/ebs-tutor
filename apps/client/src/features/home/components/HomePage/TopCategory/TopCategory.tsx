...
export const TopCategory = () => {
	...
	const colors = [
		palette.primary.primary100, palette.secondary.secondary100, palette.danger.danger100, palette.success.success100, palette.info.info100, palette.warning.warning100
	]
